...
class Collection(models.Model):
    ...
    weight = models.DecimalField(max_digits=6, decimal_places=2, default=0, blank=True, help_text='Weight in kg (0 for flat-fee collection)')
    rate = models.DecimalField(max_digits=6, decimal_places=2, default=0, blank=True, help_text='Rate per kg in INR (0 for flat-fee collection)')
